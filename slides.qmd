...
format:
  ...
  pdf:
    ...
    lof: false
    lot: false
    # Use XeLaTeX for better font handling on CI/runners; fallback to lualatex if unavailable
    pdf-engine: xelatex
    # Ensure required fonts/packages are available via header-includes
    header-includes:
      - | 
        \usepackage{fontspec}
        \usepackage{lmodern}
